			...
			<div
				...
				<div className='flex  '>
					{trendingMovies.map((movie, index) => (
						<div
							className='flex-full h-[300px] sm:h-[450px] md:h-[600px] lg:h-[700px] relative min-w-0 '
							key={index}>
							<Image
								...
								height={1080}
							/>
							<div className=' absolute top-0 pt-48 xl:pt-64 left-0 bg-gradient-to-t from-[#12121210] z-20 h-full w-full md:w-3/5  p-10 space-y-5 text-white  '>
